{include file="$template/pageheader.tpl" title=$LANG.rcdns_navzonednssectitle desc=$domain}
...
<p>{$LANG.rcdns_dnssecmanageintrotitle}</p>
...
<table class="table table-striped table-framed">
	<thead>
		<tr>
			<th>{$LANG.rcdns_dskeytag}</th>
			<th>{$LANG.rcdns_dsalgorithm}</th>
			<th>{$LANG.rcdns_dsdigesttype}</th>
			<th>{$LANG.rcdns_dsdigest}</th>
			<th>{$LANG.rcdns_dnsactions}</th>
		</tr>
	</thead>
	<tbody>
